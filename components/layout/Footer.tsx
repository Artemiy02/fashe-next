...
import PayPal from 'styles/icons/paypal.png';
import Visa from 'styles/icons/visa.png';
import MasterCard from 'styles/icons/mastercard.png';
import Express from 'styles/icons/express.png';
import Discover from 'styles/icons/discover.png';
...
const Footer = () => (
  <footer className='bg6 p-t-45 p-b-43 p-l-45 p-r-45'>
    ...
    <div className='t-center p-l-15 p-r-15'>
      <a href='#'>
        <img className='h-size2 m-r-5' src={PayPal} alt='IMG-PAYPAL' />
      </a>

      <a href='#'>
        <img className='h-size2 m-r-5' src={Visa} alt='IMG-VISA' />
      </a>

      <a href='#'>
        <img className='h-size2 m-r-5' src={MasterCard} alt='IMG-MASTERCARD' />
      </a>

      <a href='#'>
        <img className='h-size2 m-r-5' src={Express} alt='IMG-EXPRESS' />
      </a>
      ...
      <div className='t-center s-text8 p-t-20'>
        ...
        template is made with <i className='fa fa-heart-o' aria-hidden='true' />{' '}
        by{' '}
